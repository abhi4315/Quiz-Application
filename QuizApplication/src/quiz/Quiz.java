...
public class Quiz extends JFrame implements ActionListener {
	...
	Quiz( String name){
		this.name = name;
		 JLabel heading = new JLabel("Best Luck " +name);
	        heading.setBounds(570, 730, 300, 30);
        ...
        next.setBounds(1100, 520, 200, 50);
        ...
        lifeline.setBounds(1100, 600, 200, 50);
        ...
        submit.setBounds(1100, 680, 200, 50);
